...
export default function NvaveBar() {
    ...
    return (
        <>
            ...
            <motion.div
                className='font-sans w-full px-20 py-5 flex justify-between items-center fixed z-[999] bg-[rgb(24,24,27)] backdrop-blur-sm bg-opacity-40'
            ...
            >
                ...
                {/* Links Container with Hover Animation */}
                <div className="links flex gap-10">
                    {['Servises', 'our work', 'About Us', 'insights', 'contect'].map((item, index) => (
                        <motion.a
                            href=''
                            key={index}
                            className={`text-[1.2vw] text-sm font-semibold capitalize ${index === 4 && "ml-32"}`}
